...
def makeDepartmentPdf(departmentdata1, departmentdata2=[]):
    ...
    makedoc(departmentdata1['table'], departmentdata1['department'],departmentdata1['month'], departmentdata1['half'], headers, footers, tstyle, myCanvas)
    if departmentdata2:
        ...
        makedoc(departmentdata2['table'], departmentdata2['department'],departmentdata2['month'], departmentdata2['half'], headers, footers2,tstyle, myCanvas)
    myCanvas.save()
...
def makeProductionPdf(data, month, half):
    ...
    stylesheet = getSampleStyleSheet()
    Bstyle = stylesheet['Normal']
    headers = [Paragraph("<b>Meters</b>",Bstyle),Paragraph("<b>Redyeing</b>",Bstyle),Paragraph("<b>Total</b>",Bstyle),Paragraph("<b>Loans</b>",Bstyle),Paragraph("<b>Balance</b>",Bstyle)]
    tstyle = [('GRID',(0,0),(-1,-1),1, colors.black),                                                
                                                ('SPAN',(0,-2),(3,-1))]
    footers = [[],[],[],["Received By:",'','','',''],[]]
